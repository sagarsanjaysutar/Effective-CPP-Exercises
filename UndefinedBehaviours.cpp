 ...
 */
void UndefinedBehavious::printingNullPtr()
{
    int *ptr = 0;
 ...
 */
void UndefinedBehavious::outOfRangeArrAccess()
{
    char name[] = "Sagar";
...
int main()
{
    UndefinedBehavious uBObj;
    uBObj.outOfRangeArrAccess();
    uBObj.printingNullPtr();
    return 0;
}